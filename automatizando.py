...
def procesar_data_frame(df):
    ...
    df.to_csv('automatizando_datos2.csv', index=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('url', type=str, help='URL donde se descargan los datos')
    args = parser.parse_args()
    main(args.url)

    #python automatizando.py https://huggingface.co/datasets/mstz/heart_failure/raw/main/heart_failure_clinical_records_dataset.csv